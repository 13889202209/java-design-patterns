...
//        m.compute("k1",(k,v)->{ return ((String)v).concat("aaa") ;});
//
//        System.out.println(m.get("k1"));
//
//        m.merge("k1","ddd",  String::concat);
//        System.out.println(m.get("k1"));
...
//        m.compute("k1",String::concat);
//        System.out.println(m.get("k1"));


        m.compute("k1",(k,v) -> {return k.concat(v);});
        System.out.println(m.get("k1"));


//
//        m.merge("k1","cccc",(oldVal,val)->{ return ((String)oldVal).concat((String)val);});
//
//        System.out.println(m.get("k1"));
